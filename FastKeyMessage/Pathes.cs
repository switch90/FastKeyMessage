...
namespace FastKeyMessage
{
    internal class Pathes
    {
        ...
        public string MessagePath4 = @"C:\FastMessage\Message_4.txt";
        public string MessagePath5 = @"C:\FastMessage\Message_5.txt";
        public string MessagePath6 = @"C:\FastMessage\Message_6.txt";
